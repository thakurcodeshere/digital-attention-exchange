  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="space-y-1">
        ...
        <p className="text-sm text-gray-400">Earn $SITE tokens for verified high-depth dwell sessions across participating sites.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="bg-[#0E131F] p-6 rounded-2xl border border-white/10 space-y-2">
          ...
          <div className="text-3xl font-extrabold font-mono text-[#00F0FF]">+12.4 SITE</div>
        </div>
        <div className="bg-[#0E131F] p-6 rounded-2xl border border-white/10 space-y-2">
        ...
        <div className="bg-[#0E131F] p-6 rounded-2xl border border-white/10 space-y-2">
          ...
          <div className="text-3xl font-extrabold font-mono text-emerald-400">1,240 SITE</div>
        </div>
      </div>
    </div>
  );
